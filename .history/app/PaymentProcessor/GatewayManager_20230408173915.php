...
use App\PaymentProcessor\Gateways\MellatBankGateway;
use App\PaymentProcessor\Gateways\SamanKishBankGateway;
...
{    
    ...
    public function setDeriver($deriver): self
    {
        switch ($deriver) {
            case 'MELLAT':
                $this->deriver = new MellatBankGateway;
                break;
            case 'SAMANKISH':
                $this->deriver = new SamanKishBankGateway;
                break;
            default:
