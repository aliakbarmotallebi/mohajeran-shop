...
Route::group([
    'namespace' => 'Dashboard',
        ...
        'as' => 'dashboard.',
            ...
            Route::get('/settings/group-send-message/', 'SettingController@groupSendMessageQueue')
                ->name('settings.send-message');

            Route::post('/settings/group-send-message/', 'SettingController@submitGroupSendMessageQueue')
                ->name('settings.send-message.submit');
            ...
            Route::get('pinned_products/{pinned_products:condition}', 'PinnedProductController@showProducts');
