...
@section('content')
    <x-dashboard.main title="ارسال گروهی پیامک به کاربران">
        ...
        <x-dashboard.card title="ارسال گروهی پیامک به کاربران">
            <form action="{{ route('dashboard.settings.send-message.submit') }}" class="p-5 grid grid-cols-1"
                ...
                <div class="mb-6">
                    ...
                    <textarea id="message" rows="4" name="message"
                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ old('message') }}</textarea>
                </div>
