    ...
    <x-dashboard.card title="ارسال گروهی پیامک به کاربران">
        <form action="{{ route('dashboard.settings.send-message.submit') }}" class="p-5 grid grid-cols-1" enctype="multipart/form-data" method="POST">
            ...
            <div class="flex items-center mb-4">
                <input id="default-checkbox" type="checkbox" value="on" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
