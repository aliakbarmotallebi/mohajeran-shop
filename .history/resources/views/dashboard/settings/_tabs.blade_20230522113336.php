<div class="border-y border-gray-200 w-full">
    <ul class="divide-x divide-x-reverse flex whitespace-nowrap -mb-px text-sm font-medium text-center overflow-x-auto overflow-y-hidden"
        ...
        <li>
            <a href="{{ route('dashboard.sliders.index') }}" @class([
                'bg-neutral-100 text-sky-600 font-semibold border-b-2 border-sky-600' => _is_link_active(
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="ml-1 w-6 h-6 stroke-current" fill="none"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        d="M21.004 10v7.002a4.002 4.002 0 0 1-4.002 4.002H6.998a4.002 4.002 0 0 1-4.002-4.002V6.998a4.002 4.002 0 0 1 4.002-4.001H13" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        d="m2.996 13 1.296-1.295a2.412 2.412 0 0 1 3.411 0L12 16.002m-5 5.002 6.299-6.298a2.412 2.412 0 0 1 3.41 0l3.942 3.94M18.003 7.999l2.5-2.501m-5.001 0 2.5 2.5m.001.001V2.997" />
                </svg>
                گالری عکس ها
            </a>
        </li>
        <li>
            <a href="" @class([
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="ml-1 w-6 h-6 stroke-current" fill="none"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        d="M12 2v6M9 5l3-3 3 3m-3 17v-6m3 3-3 3-3-3m8-2h2a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2M7 17H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h2" />
                </svg>
                هزینه پیک
            </a>
        </li>
        <li>
            <a href="{{ route('dashboard.settings.send-message') }}" @class([
                'bg-neutral-100 text-sky-600 font-semibold border-b-2 border-sky-600' => _is_link_active(
                    'dashboard.settings.send-message'),
                'inline-flex items-center p-4 border-b-2 hover:bg-gray-50',
            ])>
                <svg xmlns="http://www.w3.org/2000/svg" class="ml-1 w-6 h-6 stroke-current" fill="none" viewBox="0 0 24 24">
                    <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16.333 3H4.667C3.746 3 3 3.746 3 4.667V13"/>
                    <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m13.5 21 1.667-3.333h4.167c.92 0 1.666-.747 1.666-1.667V7.667C21 6.746 20.254 6 19.333 6H7.667C6.746 6 6 6.746 6 7.667V16c0 .92.746 1.667 1.667 1.667H11M10 10h7m-7 4h4"/>
                </svg>
                ارسال گروهی پیامک
            </a>
        </li>
        <li>
            <a href="{{ route('dashboard.units.index') }}" @class([
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="ml-1 w-6 h-6 stroke-current" fill="none"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        d="M11 9a2 2 0 1 0-2 2v0a2 2 0 0 0 2-2Zm6 5a2 2 0 1 0-2 2v0a2 2 0 0 0 2-2Z"
                        clip-rule="evenodd" />
