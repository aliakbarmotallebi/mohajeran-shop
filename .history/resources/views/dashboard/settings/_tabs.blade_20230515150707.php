<div class="border-y border-gray-200 w-full">
    <ul class="divide-x divide-x-reverse flex whitespace-nowrap -mb-px text-sm font-medium text-center overflow-x-auto overflow-y-hidden" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
        <li>
            <a href="{{ route('dashboard.setting.settings.index') }}" 
                @class([
...
<svg xmlns="http://www.w3.org/2000/svg" class="ml-1 w-6 h-6 " fill="none" viewBox="0 0 24 24">
    ...
    <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 21H7a4 4 0 0 1-4-4V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4v10a4 4 0 0 1-4 4Z" clip-rule="evenodd"/>
        ...
        <li>
            <a href="{{ route('dashboard.setting.sliders.index') }}" 
            @class([
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="ml-1 w-6 h-6" fill="none" viewBox="0 0 24 24">
                <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21.004 10v7.002a4.002 4.002 0 0 1-4.002 4.002H6.998a4.002 4.002 0 0 1-4.002-4.002V6.998a4.002 4.002 0 0 1 4.002-4.001H13"/>
                <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m2.996 13 1.296-1.295a2.412 2.412 0 0 1 3.411 0L12 16.002m-5 5.002 6.299-6.298a2.412 2.412 0 0 1 3.41 0l3.942 3.94M18.003 7.999l2.5-2.501m-5.001 0 2.5 2.5m.001.001V2.997"/>
              </svg>
            گالری عکس ها
            </a>
        </li>
        <li>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="ml-1 w-6 h-6" fill="none" viewBox="0 0 24 24">
                <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 2v6M9 5l3-3 3 3m-3 17v-6m3 3-3 3-3-3m8-2h2a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2M7 17H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h2"/>
              </svg>
             هزینه پیک
            </a>
        </li>
        <li>
            <a href="{{ route('dashboard.setting.units.index') }}" @class([
                'bg-neutral-100 text-sky-600 font-semibold border-b-2 border-sky-600' => _is_link_active('dashboard.content.variants'),
                'inline-flex items-center p-4 border-b-2 hover:bg-gray-50'
            ])>
            <svg xmlns="http://www.w3.org/2000/svg" class="ml-1 w-6 h-6" fill="none" viewBox="0 0 24 24">
                <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2Z" clip-rule="evenodd"/>
                <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 11v7"/>
                <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11 9a2 2 0 1 0-2 2v0a2 2 0 0 0 2-2Zm6 5a2 2 0 1 0-2 2v0a2 2 0 0 0 2-2Z" clip-rule="evenodd"/>
                <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 7v5m0 4v2"/>
              </svg>
            واحد های سیستم
            </a>
        </li>
