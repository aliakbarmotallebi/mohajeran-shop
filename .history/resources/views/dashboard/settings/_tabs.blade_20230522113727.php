        ...
        <li>
            <a href="{{ route('dashboard.settings.send-message') }}" @class([
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="ml-1 w-6 h-6 stroke-current" fill="none" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16.333 3H4.667C3.746 3 3 3.746 3 4.667V13"/>
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m13.5 21 1.667-3.333h4.167c.92 0 1.666-.747 1.666-1.667V7.667C21 6.746 20.254 6 19.333 6H7.667C6.746 6 6 6.746 6 7.667V16c0 .92.746 1.667 1.667 1.667H11M10 10h7m-7 4h4"/>
                </svg>
                ارسال گروهی پیامک
            </a>
        </li>
