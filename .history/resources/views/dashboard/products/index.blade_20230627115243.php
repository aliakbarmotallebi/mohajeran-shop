    ...
    <form class="grid grid-cols-8 w-full py-5" method="GET">
      <div class="grid col-span-8 md:col-span-4 lg:col-span-3 xl:col-span-2">
        <div class="mr-4">
            ...
            <select name="category" class="categories bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
              <option value="">
