                ...
                <div class="space-x-2 space-x-reverse">
                  @if(!$product->hasImage() )
                    <button class="text-white hover:opacity-40">
                        ...
                        <svg wire:target="photo" wire:loading.class.remove="hidden" class="hidden animate-spin ml-1 mr-3 h-7 w-7 text-white" wire:loading.class.remove="hidden"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  ...
                  @else
                    <button  class="text-white hover:opacity-40">
                        <svg wire:target="removeImage" wire:loading.class="hidden" viewBox="0 0 24 24" width="24" height="24"><path d="M17 6H22V8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8H2V6H7V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6ZM18 8H6V20H18V8ZM9 11H11V17H9V11ZM13 11H15V17H13V11ZM9 4V6H15V4H9Z"></path></svg>
                        <svg wire:target="removeImage" wire:loading.class.remove="hidden" class="hidden animate-spin ml-1 mr-3 h-7 w-7 text-white" wire:loading.class.remove="hidden"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
                    </button>
