<x-partial.modal title="افزایش و کسر از اعتبار حساب کاربری" wire:model="show">
    ...
    <x-slot name="footer">
        <div class="flex items-center space-x-reverse px-2 py-3 space-x-2 rounded-b border-t border-gray-200">
            <button wire:click="save" type="button" class="text-white bg-[#1da1f2] hover:opacity-60 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                انجام عملیات
            </button>
            <button wire:click="show()" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">
                انصراف
            </button>
        </div>
    </x-slot>
