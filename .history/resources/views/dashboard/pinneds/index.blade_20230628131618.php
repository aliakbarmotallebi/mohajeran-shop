                ...
                @foreach ($products as $product)
                    <a href="#" class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 group relative">
                        <h5 class="flex items-center mb-2 text-sm font-light tracking-tight text-sky-500">
                            ...
                            <div class="mr-auto font-bold text-neutral-800">
                            ({{ $product->condition }})
                            </div>
                        </h5>
                        <div class="font-light text-gray-700">
                            ...
                            <div>
                                ...
                                <div class="font-bold pt-3 text-sky-500 text-neutral-800 ">
                                    {{ $product->name }}
                                </div>
                            </div>
                        </div>
                        <span class="bg-sky-100 absolute bottom-4 left-4 translate-x-2 rounded-md opacity-0 group-hover:opacity-50 transition-all duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24"><path d="M7.82843 10.9999H20V12.9999H7.82843L13.1924 18.3638L11.7782 19.778L4 11.9999L11.7782 4.22168L13.1924 5.63589L7.82843 10.9999Z"></path></svg>
                        </span>
                    </a>
                @endforeach
                </div>
