    ...
    <x-dashboard.main title="گالری محصولات">
        ...
        <x-dashboard.card title="گالری محصولات">
            <div class="max-w-md p-5">
                <form action="" class="items-center rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    <div class="w-full flex items-center gap-2 py-3">
                        ...
                        <button type="submit"
                            class="p-2.5 ml-2 text-sm font-medium text-white bg-blue-700">
