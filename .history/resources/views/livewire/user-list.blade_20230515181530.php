<x-dashboard.card title="لیست مشتریان">
    @foreach ($users as $user)
        <div class="flex px-6 py-6 text-grey-100 justify-between items-center border-b space-x-3 w-full">
            <div class="px-4 whitespace-nowrap flex items-center max-w-xs w-[24rem] w-full">
