                ...
                <div class="inline-flex rounded-md" role="group">
                    <button type="button" wire:click="setRoleCustomer({{ $user->id }})"
                        ...
                        @if (!$user->isVendor())
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" wire:target="setRoleCustomer({{ $user->id }})" wire:loading.remove  class="w-4 h-4 inline ml-2 fill-current"
                                viewBox="0 0 24 24">
                                <path
                    ...
                    <button type="button" wire:click="setRoleVendor({{ $user->id }})"
                        ...
                        @if ($user->isVendor())
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" wire:target="setRoleVendor({{ $user->id }})" wire:loading.remove class="w-4 h-4 inline ml-2 fill-current"
                                viewBox="0 0 24 24">
                                <path
                                    d="M10.0007 15.1709L19.1931 5.97852L20.6073 7.39273L10.0007 17.9993L3.63672 11.6354L5.05093 10.2212L10.0007 15.1709Z">
                                </path>
