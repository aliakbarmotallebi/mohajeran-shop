            ...
            <div class="px-4 whitespace-nowrap relative">
                <div class="text-right w-52 truncate">
                    ...
                    <div class="group cursor-pointer inline-block border-b border-gray-400 text-center">
                        ...
                        <div class="opacity-0 bg-black text-white text-center text-xs rounded-lg py-2 absolute z-10 group-hover:opacity-100 bottom-full mx-auto px-3 pointer-events-none inline-block">
