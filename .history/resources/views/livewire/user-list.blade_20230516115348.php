<x-dashboard.card title="لیست مشتریان">
    @foreach ($users as $user)
        <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-12  gap-y-4 m:gap-y-0 px-6 py-6 text-grey-100 justify-between items-center border-b space-x-3 w-full">
