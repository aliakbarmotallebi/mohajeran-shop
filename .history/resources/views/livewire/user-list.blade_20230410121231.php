...
<div class="flex-grow flex px-6 py-6 text-grey-100 items-center border-b">
    <div class="w-2/5 xl:w-1/4 px-4 flex items-center">
        <div class="rounded-full bg-gray-100 pl-4 inline-flex items-center">
            <div
                class="bg-slate-800 inline-block h-12 w-12 rounded-full uppercase text-white text-center align-middle leading-loose">
    ...
    <div class="px-4">
        <div class="text-right">
            <span class="text-gray-400 text-xs block w-12 overflow-hidden">
                آدرس
            </span>
