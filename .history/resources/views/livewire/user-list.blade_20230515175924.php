<x-dashboard.card title="لیست مشتریان">
    @foreach ($users as $user)
        <div class="flex-grow flex px-6 py-6 text-grey-100 justify-between items-center border-b space-x-3">
            <div class="px-4 flex items-center w-32">
                <div class="rounded-full flex bg-gray-100  group w-full overflow-hidden">
                    <div
                        class="text-xl bg-slate-800 h-full w-full min-h-12 max-w-12 rounded-full uppercase text-white text-center align-middle leading-loose">
