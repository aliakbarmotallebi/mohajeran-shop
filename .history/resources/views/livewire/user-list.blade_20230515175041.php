    ...
    @foreach ($users as $user)
        <div class="flex-grow flex px-6 py-6 text-grey-100 justify-between items-center border-b space-x-3">
            <div class="px-4 whitespace-nowrap flex items-center w-32">
                <div class="rounded-full bg-gray-100 pl-0 md:pl-4 inline-flex items-center relative group h-12 w-12">
                    <div
                    ...
                    <span class="text-lg mr-0 md:mr-2 uppercase truncate  transition-all duration-200">
