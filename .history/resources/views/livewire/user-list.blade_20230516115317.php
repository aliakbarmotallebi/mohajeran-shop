<x-dashboard.card title="لیست مشتریان">
    @foreach ($users as $user)
        <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-4  gap-y-4 m:gap-y-0 px-6 py-6 text-grey-100 justify-between items-center border-b space-x-3 w-full">
            <div class="col-span-1 lg:col-span-3 px-4 whitespace-nowrap flex items-center max-w-xs w-full">
            ...
            <div class="col-span-1 lg:col-span-3 px-4 whitespace-nowrap">
            ...
            <div class="col-span-1 lg:col-span-3 px-4 whitespace-nowrap relative">
            ...
            <div class="col-span-1 lg:col-span-3 flex text-center gap-x-1 mr-auto justify-self-end">
                <button
