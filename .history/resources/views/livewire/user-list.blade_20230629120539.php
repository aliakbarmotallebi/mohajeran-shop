        ...
        <div
            ...
            <div class="px-4 whitespace-nowrap relative">
                <div class="inline-flex rounded-md" role="group">
                    ...
                    <button type="button"
                        wire:click="setRoleVendor({{ $user->id }})"
                        class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-l-md hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 {{ $user->isVendor() ? "ring-2 ring-blue-700" : "" }}">
                        @if ($user->isVendor())
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 inline ml-2 fill-current"
                                viewBox="0 0 24 24">
                                <path
