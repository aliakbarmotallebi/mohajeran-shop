<form method="POST">
    <section
        ...
        <div class="space-y-4">
            ...
            <button
                type="submit"
                wire:target="login" wire:loading.attr="disabled" type="submit" wire:click.prevent="login()"
                class="w-full flex rounded-2xl border-b-4 border-b-blue-600 bg-blue-500 py-3 font-bold text-white hover:bg-blue-400 active:translate-y-[0.125rem] active:border-b-blue-400">
