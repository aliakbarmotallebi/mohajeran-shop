            ...
            <div class="flex text-center gap-4 mr-auto justify-self-end">
                ...
                <div class="inline-flex rounded-md" role="group">
                    <button type="button" wire:click="setRoleCustomer({{ $user->id }})"
                        class="px-2 py-1.5 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-r-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 {{ !$user->isVendor() ? 'ring-2 ring-blue-700 text-blue-700 z-10 bg-blue-300' : '' }}">
                        @if (!$user->isVendor())
