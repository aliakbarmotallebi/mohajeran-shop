<div class="grid grid-cols-12 gap-3">
  @foreach($sliders as $slider)
    <div class="grid colspan-{{$size}} transition-all duration-500 ease-in-out">
      <div class="rounded-md bg-white shadow-lg bg-cover bg-center relative overflow-hidden before:w-full before:h-full before:top-0 before:right-0 before:absolute before:z-10 before:bg-gradient-to-b before:from-transparent before:to-gray-800"
