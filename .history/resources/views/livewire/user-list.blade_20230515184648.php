<x-dashboard.card title="لیست مشتریان">
    @foreach ($users as $user)
        <div class="flex flex-col md:flex-row px-6 py-6 text-grey-100 justify-between items-center border-b space-x-3 w-full">
            <div class="px-4 whitespace-nowrap flex items-center max-w-xs min-w-[24rem]">
                <div class="rounded-full bg-gray-100 pl-0 md:pl-4 inline-flex items-center group">
                    <div
                    ...
                    <span class="text-lg mr-0 md:mr-2 uppercase truncate  transition-all duration-200 overflow-hidden">
