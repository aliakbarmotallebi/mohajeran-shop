        ...
        <div class="flex flex-col md:flex-row gap-y-4 m:gap-y-0 px-6 py-6 text-grey-100 justify-between items-center border-b space-x-3 w-full">
            ...
            <div class="px-4 whitespace-nowrap relative">
                <div class="text-right w-52 truncate">
                    ...
                    <div class="group cursor-pointer  inline-flex border-b border-gray-400 text-center">
                        {{ $user->getAddressLimit() ?? 'بدون آدرس' }}
                        <div class="opacity-0 bg-black text-white text-center text-xs rounded-lg py-2 absolute z-10 group-hover:opacity-100 bottom-full px-3 mx-auto  pointer-events-none inline">
