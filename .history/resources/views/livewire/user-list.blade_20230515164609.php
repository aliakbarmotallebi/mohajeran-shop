      ...
      <div class="flex text-center gap-x-1 mr-auto justify-self-end">
          <button
              ...
              <div class=" px-2 h-full border-l ml-1 bg-yellow-100 ">
                <svg xmlns="http://www.w3.org/2000/svg" class="fill-current h-full" viewBox="0 0 24 24" width="20"
                height="20">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="fill-current text-yellow-400" viewBox="0 0 24 24"
            width="20" height="20">
            <path fill="none" d="M0 0h24v24H0z" />
            <path
