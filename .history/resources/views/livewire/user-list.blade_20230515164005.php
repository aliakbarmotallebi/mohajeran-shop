<x-dashboard.card title="لیست مشتریان">
  ...
  <div class="flex-grow flex px-6 py-6 text-grey-100 justify-between items-center border-b space-x-3">
      ...
      <div class="flex text-center gap-x-1 mr-auto justify-self-end">
          ...
          <button
              class="flex items-center p-2 text-gray-700 bg-white rounded-lg border group border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 focus:outline-none">
