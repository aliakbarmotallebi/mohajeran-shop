    ...
    <section
        ...
        <div class="space-y-4">
            ...
            <button
                ...
                class="w-full flex justify-center rounded-2xl border-b-4 border-b-blue-600 bg-blue-500 py-3 font-bold text-white hover:bg-blue-400 active:translate-y-[0.125rem] active:border-b-blue-400">
                <span wire:loading.class="hidden" class="mx-auto text-base font-medium" >ورود</span>
