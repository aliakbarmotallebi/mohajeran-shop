    ...
    <section
        ...
        <div class="space-y-4">
            ...
            <button
                ...
                class="w-full flex justify-center rounded-2xl border-b-4 border-b-slate-600 bg-slate-500 py-3 font-bold text-white hover:bg-blue-400 active:translate-y-[0.125rem] active:border-b-blue-400">
