<form method="POST">
    <section
        ...
        <div class="space-y-4">
            ...
            <div class="w-full rounded-2xl bg-gray-50 ring-2 ring-gray-200 focus-within:ring-blue-400">
                <input  wire:model="mobile" type="text" placeholder="نام کاربری" name="mobile"
                    class="my-3 w-full border-none bg-transparent outline-none focus:outline-none" />
            </div>

            <div class="flex w-full items-center space-x-2 rounded-2xl bg-gray-50 ring-2 ring-gray-200 focus-within:ring-blue-400">
