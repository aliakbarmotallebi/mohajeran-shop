<form method="POST">
    <section
        ...
        <div class="space-y-4">
            ...
            <div class="w-full rounded-2xl bg-gray-50 px-4 ring-2 ring-gray-200 focus-within:ring-blue-400 overflow-hidden">
                <input  wire:model="mobile" type="text" placeholder="نام کاربری" name="mobile"
                    class="w-full border-none bg-transparent outline-none focus:outline-none text-2xl h-20" />
            </div>

            <div class="flex w-full items-center space-x-2 rounded-2xl bg-gray-50 px-4 ring-2 ring-gray-200 overflow-hidden focus-within:ring-blue-400">
                <input wire:model="password" type="password" placeholder="گذرواژه" name="password"
                    class="w-full border-none bg-transparent outline-none text-2xl h-20" />
