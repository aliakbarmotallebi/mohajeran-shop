<form method="POST">
    <section
        ...
        <div class="space-y-4">
            ...
            <div class="w-full rounded-2xl bg-gray-50 ring-2 ring-gray-200 focus-within:ring-blue-400 overflow-hidden">
                <input  wire:model="mobile" type="text" placeholder="نام کاربری" name="mobile"
                    class="w-full border-none bg-transparent outline-none focus:outline-none text-lg h-12 px-4" />
            </div>

            <div class="flex w-full items-center space-x-2 rounded-2xl bg-gray-50  ring-2 ring-gray-200 overflow-hidden focus-within:ring-blue-400">
                <input wire:model="password" type="password" placeholder="گذرواژه" name="password"
                    class="w-full border-none bg-transparent outline-none text-lg h-12 px-4" />
                <a href="#" class="font-medium text-gray-400 hover:text-gray-500 whitespace-nowrap px-4">!بازیـابی</a>
            </div>
