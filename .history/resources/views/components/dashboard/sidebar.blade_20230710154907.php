<aside
    ...
    x-show="isOpen()"
    class="fixed xl:static inset-0 flex bg-white bg-opacity-90 z-40 h-screen flex-col min-w-[20rem] min-w-max w-full h-auto">
    ...
    <div
        ...
        <div class="overflow-hidden text-ellipsis">
            ...
            <p class="text-xs mt-1 font-medium whitespace-nowrap text-ellipsis overflow-hidden text-right pl-1">
