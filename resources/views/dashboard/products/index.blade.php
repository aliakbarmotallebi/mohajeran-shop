    ...
    <form class="grid grid-cols-8 w-full py-5" method="GET">
      ...
      <div class="grid col-span-8 md:col-span-4 lg:col-span-3 xl:col-span-2">
        <div class="mr-4 block mb-2">
            ...
            <input name="search" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="نام ، بارکد" value="{{ request()->get('search') }}">
        </div>
      </div>
      <div class="grid col-span-8 md:col-span-4 lg:col-span-3 xl:col-span-2">
        <div class="mr-4">
      ...
      <div class="grid col-span-8 md:col-span-4 lg:col-span-3 xl:col-span-2 pt-4 md:pt-0">
          <div class="mr-auto self-end">
              ...
              <a href="{{ route('dashboard.products.index') }}" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                  پاک
              </a>
          </div>
      </div>
